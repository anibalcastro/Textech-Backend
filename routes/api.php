...
Route::get('v1/medicion/{id_cliente}', [App\Http\Controllers\Api\V1\MedicionesController::class, 'retornarMedicionesCliente']);
...
Route::get('v1/cliente/medicion/{id}',[App\Http\Controllers\Api\V1\MedicionesController::class, 'medidaId']);
